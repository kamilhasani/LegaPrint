            ...
            <div class="story-grid">
                <div class="story-image">
                    <div class="image-frame">
                        <img src="assets/images/about/farhan.jpeg" alt="Muhammad Farhan Syaakir - Founder Lega DigiPrint">
                ...
                <div class="vm-card misi-card">
                    ...
                    <div class="misi-list">
                        <div class="misi-item">
                            ...
                            <div>
                                <strong>Inovasi Teknologi</strong>
                                <p>Memperbarui fasilitas produksi dengan mesin generasi terbaru untuk hasil presisi tinggi.</p>
                            </div>
                        </div>
                        <div class="misi-item">
                            <i class="fas fa-clock"></i>
                            <div>
                                <strong>Ketepatan Janji</strong>
                                <p>Mengintegrasikan sistem produksi yang disiplin demi menjamin pengiriman tepat waktu.</p>
                            </div>
                        </div>
                        <div class="misi-item">
                            <i class="fas fa-chalkboard-user"></i>
                            <div>
                                <strong>Solusi Konsultatif</strong>
                                <p>Memberikan edukasi dan saran teknis terbaik agar klien mendapatkan hasil optimal.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="priority-grid">
                <div class="priority-card">
                    ...
                    <p>Kami hanya menggunakan tinta dan bahan premium untuk hasil yang tahan lama dan memukau.</p>
                    <div class="priority-hover"></div>
                </div>
                <div class="priority-card">
                    ...
                    <p>Waktu adalah uang. Kami menjamin proses produksi yang cepat dan sesuai dengan jadwal.</p>
                    <div class="priority-hover"></div>
                </div>
                <div class="priority-card">
